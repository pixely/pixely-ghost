...
module.exports = function (config) {
    ...
    config.addFilter('stripDomain', url => stripDomain(url))
    ...
    config.addFilter('getTags', tags => ghostHelpers.tags(tags))

    config.addFilter('getRelativeTime', date => date)
    ...
    config.addFilter('htmlDateString', dateObj => new Date(dateObj).toISOString().split('T')[0])
